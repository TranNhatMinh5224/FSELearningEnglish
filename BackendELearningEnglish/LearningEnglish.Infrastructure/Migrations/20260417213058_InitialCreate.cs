    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolicyKnowledges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PolicyKnowledges_Policies_PolicyId",
                        column: x => x.PolicyId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherPackageKnowledges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherPackageKnowledges_TeacherPackages_TeacherPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseKnowledges", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CourseId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Title = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    DescriptionMarkdown = table.Column<string>(type: "character varying(1000000)", maxLength: 1000000, nullable: false),
                    ImageKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    MarkdownContent = table.Column<string>(type: "character varying(5000000)", maxLength: 5000000, nullable: true),
                    MediaKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    MediaType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: ""),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, new DateTime(2004, 2, 5, 0, 0, 0, 0, DateTimeKind.Utc), "minhxoandev@gmail.com", true, "Super Admin", true, "System", "MINHXOANDEV@GMAIL.COM", "$2a$11$.9GfvVH0q9cOca8HA2QEAuOGH3V7NqfZMxtf4QTcX/fyt3loPt.Te", "0257554479", 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseKnowledges_CourseId",
                table: "CourseKnowledges",
                column: "CourseId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolicyKnowledges_PolicyId",
                table: "PolicyKnowledges",
                column: "PolicyId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherPackageKnowledges_TeacherPackageId",
                table: "TeacherPackageKnowledges",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CourseKnowledges_Courses_CourseId",
                table: "CourseKnowledges",
                column: "CourseId",
                principalTable: "Courses",
                principalColumn: "CourseId",
