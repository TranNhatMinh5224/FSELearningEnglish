namespace LearningEnglish.Application.DTOs
{
    ...
    public class ListFlashCardDto
    {
        ...
        public string? Pronunciation { get; set; }
        public string? ImageUrl { get; set; }
        public string? ImageType { get; set; }  // Loại hình ảnh
        public string? AudioUrl { get; set; }
        public string? AudioType { get; set; }  // Loại audio
        public string? PartOfSpeech { get; set; }  // Từ loại
        public string? Example { get; set; }  // Ví dụ
        public string? ExampleTranslation { get; set; }  // Bản dịch ví dụ
        public string? Synonyms { get; set; }  // Từ đồng nghĩa
