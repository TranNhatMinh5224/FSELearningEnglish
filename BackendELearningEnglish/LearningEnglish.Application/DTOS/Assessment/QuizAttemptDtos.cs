...
namespace LearningEnglish.Application.DTOs
{
    ...
    public class AttemptQuizSectionDto
    {
        ...
        public string? Description { get; set; }  // Mô tả section
    ...
    public class QuizItemDto
    {
        ...
        public string? Name { get; set; }  // Tên group ngắn gọn (Part 1, Part 2)
        public string? Title { get; set; }  // Tiêu đề (Photographs, Short Conversations)
        public string? Description { get; set; }  // Nội dung đoạn văn/bài đọc để học viên đọc
