      ...
      >
          ...
          {loadingQuiz ? (
            ...
            <form onSubmit={(e) => {
              ...
              <div className="form-section-card">
                <div className="form-section-title"><FaInfoCircle /> Thông tin chung</div>
                ...
                <div className="mb-3">
                  ...
                  <textarea
                    ...
                    placeholder="Nhập mô tả ngắn về bài Quiz này (không bắt buộc)"
                    rows={2}
                    maxLength={1000}
                  />
                ...
                <div className="mb-0">
                  ...
                  <textarea
                    ...
                    placeholder="Hướng dẫn chi tiết cho học sinh trước khi bắt đầu (không bắt buộc)"
                    rows={2}
                    maxLength={2000}
                  />
              ...
              <div className="form-section-card">
                <div className="form-section-title"><FaCog /> Cấu hình cơ bản</div>
                <Row className="g-3">
                  <Col md={6}>
                    <div>
              ...
              {/* SECTION 3: SCORING */}
              <div className="form-section-card">
                <div className="form-section-title"><FaListOl /> Điểm số & Câu hỏi</div>
                <Row className="g-3">
                  <Col md={6}>
                    <div className="mb-3">
                  ...
                  <Col md={6}>
                    <div className="mb-3">
                      <label className="form-label required">Thang điểm tối đa</label>
                      <input
                        type="text"
                        inputMode="decimal"
              ...
              <div className="form-section-card mb-4">
                <div className="form-section-title"><FaClock /> Cài đặt thời gian</div>
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            type="button"
          >
            {submitting ? (isUpdateMode ? "Đang cập nhật..." : "Đang tạo...") : (isUpdateMode ? "Cập nhật Quiz" : "Tạo Quiz")}
          </Button>
        </Modal.Footer>
      </Modal>
