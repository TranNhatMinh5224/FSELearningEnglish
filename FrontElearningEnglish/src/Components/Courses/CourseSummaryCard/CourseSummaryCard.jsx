...
export default function CourseSummaryCard({ course, onEnroll, onStartLearning }) {
    ...
    return (
        <div className="course-summary-card d-flex flex-column">
            ...
            <div className="course-summary-stats-grid">
                <div className="course-stat-tile lessons">
                ...
                {course.enrollmentCount !== undefined && (
                    <div className="course-stat-tile students">
                        <div className="stat-icon-box">
                ...
                {priceDisplay !== null && (
                    <div className="course-stat-tile price">
                        <div className="stat-icon-box">
